...
$sounds = new WP_Query($args);
if ( $sounds->have_posts()) :
while ( $sounds->have_posts()) : $sounds->the_post(); // begin the Loop 
...
<div class="post-text-grip">
    ...
    echo $blog_quote;  } else {  
     the_advanced_excerpt('no_shortcode=0&use_words=1&length=30&exclude_tags=p&allowed_tags=iframe'); 
} ?> 
