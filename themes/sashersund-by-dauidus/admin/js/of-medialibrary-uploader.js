...
/*-----------------------------------------------------------------------------------*/
  ...
  }; // End Threesixty_optionsMLU Object // Don't remove this, or the sky will fall on your head.

/*-----------------------------------------------------------------------------------*/
/* Execute the above methods in the Threesixty_optionsMLU object.
/*-----------------------------------------------------------------------------------*/
  
	$(document).ready(function () {

		Threesixty_optionsMLU.removeFile();
		Threesixty_optionsMLU.recreateFileField();
		Threesixty_optionsMLU.mediaUpload();
