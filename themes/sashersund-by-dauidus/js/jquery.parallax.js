...
(function(jQuery, undefined) {
	...
	var options = {
	    	mouseport:	'#header-index',    // jQuery object or selector of DOM node to use as mouse detector
	    	xparallax:	'10px',      // boolean | 0-1 | 'npx' | 'n%' - Sets axis of reaction and by how much they react
	    	yparallax:	false,      //
	    	xorigin:		0.5,       // 0-1 - Sets default alignment. Only has effect when parallax values are something other than 1 (or true, or '100%')
	    	yorigin:		0,       //
	    	decay:			0,      // 0-1 (0 instant, 1 forever) - Sets rate of decay curve for catching up with target mouse position
	    	frameDuration:	10,    // Int (milliseconds)
	    	freezeClass:	'true' // String - Class added to layer when frozen
	    },
