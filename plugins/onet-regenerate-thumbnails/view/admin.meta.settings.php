<form action="" method="post" class="saveditor">
	...
	<div style="<?php echo $opts->advanced == 1 ? "" : "display:none;"; ?>">
		...
		<p><input type="checkbox" name="succes_redir" id="succes_redir" <?php echo $opts->succes_redir == 1 ? 'checked="checked"' : "" ?> />
			<label for="succes_redir" title="<?php _e('Redirect user when process is done.', 'onetrt'); ?>"><em><?php _e('Redirect on success', 'onetrt'); ?></em></label>
		</p>
