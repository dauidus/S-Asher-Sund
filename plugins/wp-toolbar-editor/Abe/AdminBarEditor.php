...
class Abe_AdminBarEditor {
	...
	/** @var string Per-site option that specifies whether to use a site-specific config instead of the global one. */
    ...
    public function __construct() {
        ...
        add_action('admin_bar_menu', array($this, 'filterAdminBar'), self::ADMIN_BAR_FILTER_PRIORITY);
     ...
     */
    public function filterAdminBar($adminBar) {
